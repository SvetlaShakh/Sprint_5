...
class TestTabOfConstructor:
    ...
    def test_click_tab_bun_constructor_current_list(self, driver):
        ...
        WebDriverWait(driver, 5).until(
            expected_conditions.presence_of_element_located(BurgersLocators.TAB_SAUCES_CURRENT))
        driver.find_element(*BurgersLocators.TAB_BUNS).click()
        WebDriverWait(driver, 5).until(
            expected_conditions.presence_of_element_located(BurgersLocators.TAB_BUNS_CURRENT))
