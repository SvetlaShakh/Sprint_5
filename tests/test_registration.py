...
class TestRegistration:
    ...
    def test_registration_text_on_button_place_an_order(self, driver, add_data_for_registration):
        name = add_data_for_registration[0]
        email = add_data_for_registration[1]
        password = add_data_for_registration[2]
        ...
        driver.find_element(*BurgersLocators.INPUT_NAME_REGISTER_WINDOW).send_keys(name)
    ...
    def test_registration_text_password_len_less_then_6_password_text_error(self, driver, add_data_for_registration):
        name = add_data_for_registration[0]
        email = add_data_for_registration[1]
